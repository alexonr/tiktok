...
$( document ).ready( function() {  
    ...
    function newActivity() {
        ...
        var avatars = [ 'https://i.imgur.com/CFGJQzH.png',
                        'https://i.imgur.com/CFGJQzH.png'];
        ...
        $( '.activityContent' ).hide().prepend('<div class="live-stats">' +
           ...
           '<div class="info">' +
              '<ul>' +
                 ...
                 '<li><img class="item-gen" src="img/vBucks.png" alt="" />Likes: <span class="bucks-color">' + vBucksRand + '</span> </li>' +
              '</ul>' +
           '</div>' +
        '</div>').fadeIn();
    }
    ...
    function progressBar() {
        ...
        function frame() {
            ...
            if( width == 70 ) $( '.load-textJS' ).html( 'GET -> Likes' );
